# fraud_detection_app.py - FINAL VERSION WITH PASSWORD CHANGE FEATURE
...
def admin_management_page():
    ...
    tab1, tab2, tab3, tab4 = st.tabs([" User Management", "➕ Create New User", "🔐 Change Password", "⚙️ System Settings"])
